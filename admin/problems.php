		...
		<div> 
			...
			<ul class="nav nav-list">
	          	  ...
	          	  if(mysql_num_rows($result)==0)
	          	    ...
	          	    while($row = mysql_fetch_array($result)) {
	          	      if(isset($_GET['action']) and $_GET['action']=='edit' and isset($_GET['id']) and $_GET['id']==$row['sl']) {
	          	        $selected = $row;
	          	        echo("<li class=\"active\"><a href=\"problems.php?action=edit&id=".$row['sl']."\"><i class=\"glyphicon glyphicon-chevron-right\">&nbsp;</i>".$row['name']."</a></li>\n");
	          	      } else
	          	        echo("<li><a href=\"problems.php?action=edit&id=".$row['sl']."\"><i class=\"glyphicon glyphicon-chevron-right\">&nbsp;</i>".$row['name']."</a></li>\n");
	          	    }
	          	  }
	          	?>
				<li class="divider"></li>
          	  ...
          	  if(!isset($_GET['action']) and !isset($_GET['id']))
          	    echo("<li class=\"active\"><a href=\"#\"><i class=\"glyphicon glyphicon-plus\">&nbsp;</i>Add problem</a></li>\n");
          	  else
          	    echo("<li><a href=\"problems.php\"><i class=\"glyphicon glyphicon-plus\">&nbsp;</i>Add problem</a></li>\n");
          	?>
			</ul>
			<hr/>
			<?php
			...
			<form method="post" action="update.php">
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab1"> 
							...
							<textarea style="height:400px;" class="form-control" name="problem" id="text"><?php echo str_replace("<br>", "", $selected['text']);?></textarea>
							</div>
						</div>
			...
			<form method="post" action="update.php" >
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab1"> 
							...
							<div class="form-group">
							<label for="exampleInputEmail1">Detailed problem <span class="label label-info">Markdown formatting supported</span> :</label>
							<textarea style="height:400px;" class="form-control" name="problem" id="text">
							<?php echo '<span class="label label-success">Task</span>
							<span class="label label-success">Input</span>
							<span class="label label-success">Output</span>';?></textarea>
							</div>
						</div>
