	...
	<div>
		<div> 
			...
			if(!isset($_GET['action']) and !isset($_GET['id']))
				...
				echo("<a href=\"problems.php\"><i class=\"glyphicon glyphicon-plus\">&nbsp;</i>Add problem</a>\n");
			?>
			<br/><br/>
				...
				<?php
					...
					if(mysql_num_rows($result)==0)
						echo("<li>None</li>\n");
	          	    	...
	          	    	while($row = mysql_fetch_array($result)) 
						{
						  	echo("<li><a href=\"problems.php?action=edit&id=".$row['sl']."\">".$row['name']."</a> <div class='pull-right'> <i class=\"glyphicon glyphicon-ok\">&nbsp;</i>".$row['title']."</div></li>\n");
				   	...
				   	<form method="post" action="update.php" >
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1"> 
								...
								<div class="form-group">
								<label for="exampleInputEmail1">Detailed problem <span class="label label-info">Markdown formatting supported</span> :</label>
								<textarea style="height:200px;" class="form-control" name="problem" id="text">
